...
from config import IMG_SIZE, DATA_PATH_CATS, BATCH_SIZE, NUM_WORKERS

warnings.filterwarnings("ignore")

print("Processing Cats Breeds...")
...
dsets = {x: datasets.ImageFolder(os.path.join(DATA_PATH_CATS, x), transform[x])
         for x in ['train', 'test']}
