...
def train_model(model, criterion, optimizer, lr_scheduler, num_epochs=NUM_EPOCHS):
    ...
    for epoch in range(num_epochs):
        ...
        with open('models/dogs/model__dogs__Epoch__ ' + str(num_epochs) + '__LR__' + str(LR) + '.txt', 'a') as f:
            f.write(results)
...
# Set the logger
logger = Logger('models/dogs/logs')
...
torch.save(model.state_dict(), 'models/dogs/model_dogs_breeds.pkl')
