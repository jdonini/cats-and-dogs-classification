...
def train_model(model, criterion, optimizer, lr_scheduler, num_epochs=NUM_EPOCHS):
    ...
    for epoch in range(num_epochs):
        ...
        with open('models/breeds/model__breeds__Epoch__ ' + str(num_epochs) + '__LR__' + str(LR) + '.txt', 'a') as f:
            f.write(results)
...
logger = Logger('models/breeds/logs')
...
torch.save(model.state_dict(), 'models/breeds/model_breeds.pkl')
