...
def train_model(model, criterion, optimizer, lr_scheduler, num_epochs=NUM_EPOCHS):
    ...
    for epoch in range(num_epochs):
        ...
        with open('models/cats/model__cats__Epoch__ ' + str(num_epochs) + '__LR__' + str(LR) + '.txt', 'a') as f:
            f.write(results)
...
# Set the logger
logger = Logger('models/cats/logs')
...
torch.save(model.state_dict(), 'models/cats/model_cats_breeds.pkl')
